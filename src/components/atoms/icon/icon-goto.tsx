...
export const IconGoto = ({ 
  ...
  const viewBox = '0 0 188.111 188.111';
  ...
  return (
    <IconStyled size={size}  title={title}>
      ...
      >
        <PathStyled color={color} d="M122.735,55.676L53.951,82.395c-2.797,1.086-4.677,3.736-4.78,6.735c-0.103,2.999,1.592,5.771,4.309,7.045l26.172,12.286
        ...
        <PathStyled color={color} d="M94.052,0C42.192,0.001,0.001,42.194,0.001,94.055c0,51.862,42.191,94.056,94.052,94.057
